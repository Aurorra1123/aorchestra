...
from benchmark.common.env import Observation, Action, BasicInfo
...
you should output the action name, parameters and memory in the JSON format, and only one action.
Such as, 
```json
{{
    "action": "",
...
class InteractCompAgent(ReAcTAgent):
    ...
    def reset(self, env_info: "BasicInfo") -> None:
        ...
        self.question = env_info.meta_data['question']
        self.memory.clear()
